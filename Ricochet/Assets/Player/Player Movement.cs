...
//     version 1.17.0
//     from Assets/Player/Player Movement.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Player/Player Movement.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerMovement: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Moving"",
            ""id"": ""003e8d81-6617-41f2-b50e-a2cf236cadca"",
            ""actions"": [
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""b9ef72f6-4798-430d-86dd-94dcee10fa0a"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""b9234873-a86b-4ef7-9e54-29da04818a0d"",
                ...
                },
                {
                    ""name"": ""Camera Control"",
                    ""type"": ""Value"",
                    ""id"": ""735cf945-c0d8-4747-bd76-92536e82ea97"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""2c472d7e-4a66-4993-9c3c-22cb72192e50"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Keyboard"",
                    ""id"": ""c8d64d38-fde6-4d17-b732-e7510df274e9"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""b93d602b-5659-4cd5-9eb6-97f9ee1810d7"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""64152b31-e116-468d-97a1-09b2128251ee"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""852c98d9-d17f-45ed-82b7-ee1376b49fa2"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""7716a2b0-5470-4310-92d2-402c96e79b1c"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""14b0cf22-f49a-454a-a34e-bd66915d1c8f"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@PlayerMovement()
    {
        UnityEngine.Debug.Assert(!m_Moving.enabled, "This will cause a leak and performance issues, PlayerMovement.Moving.Disable() has not been called.");
    }
    ...
    public struct MovingActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Moving/Movement".
        /// </summary>
